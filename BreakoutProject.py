...
def breakout():
    ...
    def bricks():
        ...
        START_Y = 75
        N_COLS = 10
        starting_width = (gw.getWidth() - (N_COLS * (BRICK_WIDTH + BRICK_SEP)))

        #For loops for the red bricks

        width = starting_width
        for i in range(N_COLS + 1):
            brick = GRect(width, START_Y, BRICK_WIDTH, BRICK_HEIGHT)
        ...
        width = starting_width
        for i in range(N_COLS + 1):
            brick = GRect(width, START_Y + BRICK_HEIGHT + BRICK_SEP,
        ...
        #For loops for the orange bricks  
        ...
        width = starting_width
        for i in range(N_COLS + 1):
            brick = GRect(width, START_Y + 2*(BRICK_HEIGHT + BRICK_SEP),
                          BRICK_WIDTH, BRICK_HEIGHT)
            brick.set_filled(True)
            brick.set_color('Orange')
            gw.add(brick)
            width += BRICK_WIDTH + BRICK_SEP
        ...
        width = starting_width
        for i in range(N_COLS + 1):
            brick = GRect(width, START_Y + 3*(BRICK_HEIGHT + BRICK_SEP),
                          BRICK_WIDTH, BRICK_HEIGHT)
            brick.set_filled(True)
            brick.set_color('Orange')
            gw.add(brick)
        ...
        width = starting_width
        for i in range(N_COLS + 1):
            brick = GRect(width, START_Y + 4*(BRICK_HEIGHT + BRICK_SEP),
                          BRICK_WIDTH, BRICK_HEIGHT)
            brick.set_filled(True)
            brick.set_color('Green')
            gw.add(brick)
            width += BRICK_WIDTH + BRICK_SEP
        ...
        width = starting_width
        for i in range(N_COLS + 1):
            brick = GRect(width, START_Y + 5*(BRICK_HEIGHT + BRICK_SEP),
                          BRICK_WIDTH, BRICK_HEIGHT)
            brick.set_filled(True)
            brick.set_color('Green')
            gw.add(brick)
        ...
        width = starting_width
        for i in range(N_COLS + 1):
            brick = GRect(width, START_Y + 6*(BRICK_HEIGHT + BRICK_SEP),
                          BRICK_WIDTH, BRICK_HEIGHT)
            brick.set_filled(True)
            brick.set_color('Cyan')
            gw.add(brick)
            width += BRICK_WIDTH + BRICK_SEP
        ...
        width = starting_width
        for i in range(N_COLS + 1):
            brick = GRect(width, START_Y + 7*(BRICK_HEIGHT + BRICK_SEP),
                          BRICK_WIDTH, BRICK_HEIGHT)
            brick.set_filled(True)
            brick.set_color('Cyan')
            gw.add(brick)
        ...
        width = starting_width
        for i in range(N_COLS + 1):
            brick = GRect(width, START_Y + 8*(BRICK_HEIGHT + BRICK_SEP),
                          BRICK_WIDTH, BRICK_HEIGHT)
            brick.set_filled(True)
        ...
        width = starting_width
        for i in range(N_COLS + 1):
            brick = GRect(width, START_Y + 9*(BRICK_HEIGHT + BRICK_SEP),
                          BRICK_WIDTH, BRICK_HEIGHT)
            brick.set_filled(True)
            brick.set_color('Blue')
            gw.add(brick)
